...
class Environment:
	...
	def _load_settings(self):	
		...
		if "settings.dat" in os.listdir("Saves"):
			...
			with open("/home/chendh/Course_Projects/EECS_598_003/Final_Project/Code/JumpKingAtHome-master/Saves/settings.dat", "rb") as file:
	...
	def _load_stats(self):
		...
		if "save.dat" in os.listdir("Saves"):
			...
			with open("/home/chendh/Course_Projects/EECS_598_003/Final_Project/Code/JumpKingAtHome-master/Saves/save.dat", "rb") as file:
		...
		if "permanent.dat" in os.listdir("Saves"):
			...
			with open("/home/chendh/Course_Projects/EECS_598_003/Final_Project/Code/JumpKingAtHome-master/Saves/permanent.dat", "rb") as file:
