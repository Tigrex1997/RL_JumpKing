...
class Rectangles:
	...
	def __init__(self):  #self, x, y, width, height, slope = False, slip = False, support = False, snow = False
		...
		self.levels[0]	=	[(352, 185, 128, 175, 0, 0, False, False),
							...
							(0, 0, 8, 360, 0, 0, False, False),  # Left wall
							(472, 0, 8, 360, 0, 0, False, False)]  # Right wall
