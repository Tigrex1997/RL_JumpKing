...
class Crow(Flyer):
	...
	def _load_images(self):
		...
		fly_images = SpriteSheet("./{}/{}".format(self.directory, self.filename1)).load_grid(start_rect1, 3, 2, -1)

		idle_images = SpriteSheet("./{}/{}".format(self.directory, self.filename2)).load_grid(start_rect2, 4, 2, -1)
