...
class Levels:
	...
	def __init__(self, screen):
		...
		self.background = None#Backgrounds("BG").backgrounds

		self.midground = Backgrounds("Semantic_MG").backgrounds

		self.foreground = None#Backgrounds("FG").backgrounds

		self.props = None#Props().props
