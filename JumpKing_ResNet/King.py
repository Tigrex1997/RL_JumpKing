		...
		if self.isWalk:
			...
			if self.walkCount <= 5:
				if not self.isHoldingBabe:
					...
					self.current_image = self.sprites["ending"]["King_Walk1_{}".format(self.direction)]

			elif self.walkCount <= 8:
				if not self.isHoldingBabe:
					self.current_image = self.sprites[self.direction]["King_MidWalk"]
				else:
					self.current_image = self.sprites["ending"]["King_MidWalk_{}".format(self.direction)]

			elif self.walkCount <= 13:
				if not self.isHoldingBabe:
					self.current_image = self.sprites[self.direction]["King_Walk2"]
				else:
					self.current_image = self.sprites["ending"]["King_Walk2_{}".format(self.direction)]
			...
			if self.isSplat:
				...
				if self.isHoldingBabe:
					self.current_image = self.sprites["ending"]["King_Hold_Babe_{}".format(self.direction)]
