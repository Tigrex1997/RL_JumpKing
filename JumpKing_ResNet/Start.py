...
class Start:
	...
	def _load_audio(self):
		...
		for audio_name in os.listdir("./Audio/start"):
			...
			audio[re.match(r"[^.]+", audio_name).group()] = pygame.mixer.Sound("./Audio/start/{}".format(audio_name))
	...
	def _load_images(self):
		...
		for image_name in os.listdir("./images/logos"):
			...
			images[re.match(r"[^.]+", image_name).group()] = pygame.image.load("./images/logos/{}".format(image_name)).convert_alpha()
