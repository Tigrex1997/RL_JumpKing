...
class King_Sprites():
	...
	def __init__(self):
		...
		self.filename = "./images/sheets/base.png"#"Semantic_images/base_semantic.png"

		self.filename2 = "./images/sheets/ending_animations.png"#"Semantic_images/ending_animations_semantic.png"
